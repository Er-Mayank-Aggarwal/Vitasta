...
export default function AuthForm({ onSuccess, isModal = false }) {
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-white border border-neutral-200 rounded-2xl shadow-xl p-4 sm:p-7 text-[#1A1A1A] max-h-[90vh] overflow-y-auto">
      ...
      {/* Alerts */}
      {error && (
        <div className="mb-3 p-2.5 rounded-lg bg-rose-50 border border-rose-200 text-rose-700 text-xs flex items-start gap-2">
      ...
      {success && (
        <div className="mb-3 p-2.5 rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs flex items-start gap-2">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2.5 py-2 px-3 rounded-xl border border-neutral-300 bg-white hover:bg-neutral-50 transition font-medium text-xs sm:text-sm text-neutral-700 shadow-xs hover:shadow-sm active:scale-[0.99] disabled:opacity-60 mb-3 cursor-pointer"
      >
        <GoogleLogo size={16} />
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-1.5 text-xs sm:text-sm rounded-xl border border-neutral-300 bg-neutral-50/50 text-[#1A1A1A] focus:outline-none focus:ring-1 focus:ring-[#0B3B60] focus:bg-white"
              />
            </div>
          </div>
        )}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="••••••••"
              className="w-full pl-8 pr-9 py-1.5 text-xs sm:text-sm rounded-xl border border-neutral-300 bg-neutral-50/50 text-[#1A1A1A] focus:outline-none focus:ring-1 focus:ring-[#0B3B60] focus:bg-white"
            />
            <button
              type="button"
        ...
        <button
          ...
          className="w-full py-2 px-4 rounded-xl bg-[#0B3B60] hover:bg-[#071E3D] text-white font-medium text-xs sm:text-sm tracking-wide shadow-sm hover:shadow transition active:scale-[0.99] disabled:opacity-60 flex items-center justify-center gap-2 cursor-pointer"
        >
          {isLoading ? (
            'Processing...'
          ) : isLogin ? (
            <>
              <LogIn className="w-3.5 h-3.5" /> Sign In to Atelier
            </>
          ) : (
            <>
      ...
      <div className="mt-3 text-center text-[11px] text-neutral-500">
        ...
        <button
          ...
          className="text-[#C1272D] font-semibold underline hover:opacity-80 cursor-pointer"
        >
